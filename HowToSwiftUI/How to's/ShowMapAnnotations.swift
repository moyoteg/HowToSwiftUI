//
//  ShowMapAnnotations.swift
//  HowToSwiftUI
//
//  Created by Moi Gutierrez on 7/12/21.
//

import SwiftUI
import MapKit

struct ShowMapAnnotations: View {
    ...
    @State var annotations = [
        ...
        Annotation(name: "lasso", latitude: 9, longitude: 8),
    ]
...
struct ShowMapAnnotations_Previews: PreviewProvider {
